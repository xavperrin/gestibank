                    ...
                    <h2>Creez votre compte</h2>
                        <form method="post" action="subscribe.jsp">
                            <div class="form-group">
                                <label for="labelFirstname">Votre prénom : </label>
                                <input type="text" name="firstname" id="labelFirstname">
                            </div>
                            <div class="form-group">
                                <label for="labelLaststname">Votre nom de famille : </label>
                                <input type="text" name="lastname" id="labelLaststname">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="labelFileId2Upload">Votre pièce d'identité </label>
                                <input type="file" name="fileId2Upload" id="labelFileId2Upload">
                            </div>

                            <div class="form-group">
                                <label for="labelFileSalary2Upload">Votre pièce justificative de salaire</label>
                                <input type="file" name="fileSalary2Upload" id="labelFileSalary2Upload">
                            </div>
                            
                            <div class="form-group">
                                <label for="labelFileProofOfAddress2Upload">Votre pièce justificative de domicile</label>
                                <input type="file" name="fileProofOfAddress2Upload" id="labelFileProofOfAddress2Upload">
                            </div>
